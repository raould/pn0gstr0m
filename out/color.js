...
var randomSpec = {
  get regular() {
    return [gR.RandomRangeInt(0, 255), gR.RandomRangeInt(0, 255), gR.RandomRangeInt(0, 255)];
  },
  get strong() {
    return [gR.RandomRangeInt(128, 255), gR.RandomRangeInt(128, 255), gR.RandomRangeInt(128, 255)];
  }
};
function makeRandomSpec() {
  var r = [gR.RandomRangeInt(0, 255), gR.RandomRangeInt(0, 255), gR.RandomRangeInt(0, 255)];
  var bump = 255 - Math.max(r[0], r[1], r[2]);
  var s = [r[0] + bump, r[1] + bump, r[2] + bump];
  return {
    regular: r,
    strong: s
  };
...
function lerp_rgba255s(src255, dst255, alpha, t) {
  ...
  if (t > 0.99) {
    ...
    return rgba255s([lerp_channel(src255[0], dst255[0], t), lerp_channel(src255[1], dst255[1], t), lerp_channel(src255[2], dst255[2], t)], alpha);
  }
}
function ColorCycle() {
...
function FadeIn(alpha) {
  var dstSpec = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
  if (gMonochrome) {
    // i.e. attract mode.
    ...
    if (isU(dstSpec)) {
      ...
      if (t > 0.99) {
        ...
        return lerp_rgba255s(greenSpec.strong, gR.RandomBool() ? dstSpec.regular : dstSpec.strong, alpha, t);
      }
    }
  }
  return undefined;
